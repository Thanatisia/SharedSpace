# DIY - Creating your own Android application project workspace/development environment from scratch and building from command line

## Information
### Description
+ Full documentation on setting up an Android Mobile Application Development project workspace/development environment entirely from the command line 
...
- Create a new Android project workspace directory
    ```console
